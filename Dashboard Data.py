...
st.set_page_config(page_title="Project Budget Forecast Dashboard", layout="wide")
...
required_columns = ['Project', 'Sprint', 'Role', 'Bandwidth', 'FTE/week', 'Role Cost',
                    'Cost / week', 'Cost / sprint', 'Planned', 'Actuals']
...
sprint_range = st.slider("Select Sprint Range", min_value=1, max_value=10, value=(1, 10))
...
for project in selected_projects:
    ...
    ax.plot(combined_sprints, combined_planned, marker='o', label=f'{project} - Planned')
    ax.plot(combined_sprints, combined_actuals, marker='o', label=f'{project} - Actual')

ax.set_title('Forecasted vs Actual Budget per Sprint')
